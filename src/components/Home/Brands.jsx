    ...
    return (
        <div className=" max-w-6xl mx-auto"  >
           ...
           <div className=" shadow-2xl shadow-green-300" >
            <img className="w-full h-36" src="../../../public/Brands/31cfd91636fceeca4a9787af9964195c1.png" alt="" />
            <h1 className=" text-2xl font-bold text-center" > Chanel </h1>
           </div>

           <div className=" shadow-2xl shadow-green-300" >
            <img className="w-full h-36 lg:ml-12" src="../../../public/Brands/f255270af7e35ac8a7a8560a32bff08a2.png" alt="" />
            <h1 className=" text-2xl text-center font-bold" > Prada </h1>
           </div>

           <div className=" shadow-2xl shadow-green-300" >
            <img className="w-full h-36" src="../../../public/Brands/7528b513e759e945b03f76c68548908b3.png" alt="" />
            <h1 className=" text-2xl text-center font-bold" > Puma </h1>
           </div>

           <div className=" shadow-2xl shadow-green-300" >
            <img className="w-full h-36" src="../../../public/Brands/82b2f710eccb28acfbea441492b9974b4.png" alt="" />
            <h1 className=" text-2xl text-center font-bold" > Hermes </h1>
           </div>

           <div className=" shadow-2xl shadow-green-300" >
            <img className="w-full h-36" src="../../../public/Brands/a15dccb58e516ed628c57bb0b45e56e5.png" alt="" />
            <h1 className=" text-2xl text-center font-bold" > Louis Vuitton </h1>
           </div>

           <div className=" shadow-2xl shadow-green-300" >
            <img className="w-full h-36" src="../../../public/Brands/26506329d528fe7231b945c841017b1b6.png" alt="" />
